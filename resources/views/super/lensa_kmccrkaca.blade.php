          ...
          <table class="table table-bordered table-contextual table-hover table-striped">
            ...
            <tbody>
             ...
             <tr>
               ...
               <td> {{ $data -> stock}} </td>
               <td>
                <a href="/lensakmccrkaca/{{$data->id}}/edit" class="btn btn-warning btn-sm" role="button">Edit</a>
                <a href="/lensakmccrkaca/delete/{{$data->id}}" class="btn btn-danger btn-sm" role="button">
