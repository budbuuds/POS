...
<div class="col-lg-12 stretch-card">
    <div class="card">
      <div class="card-body">
        <h4 class="card-title"> Toko Emeral </h4>
        <a href="/emeral/export" class="btn btn-success my-3" target="_blank">EXPORT EXCEL</a>
          ...
          <table class="table table-bordered table-contextual table-hover table-striped">
            ...
            <tbody>
             ...
             <tr>
               ...
               <td> {{$data -> pj}} </td>
               <td>
                <a href="/emeral/{{$data->id}}/edit" class="btn btn-warning btn-sm" role="button">Edit</a>
                <a href="/emeral/delete/{{$data->id}}" class="btn btn-danger btn-sm" role="button">
        ...
        <div class="modal-content">
            <div class="modal-header">
                ...
                <div class="modal-body">
                    <form action="/super/emeral/create" method="POST">
                        {{csrf_field()}}
                            <div>
