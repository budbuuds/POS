...
<div class="col-lg-12 stretch-card">
    <div class="card">
      <div class="card-body">
        <h4 class="card-title"> Stok Frame Original </h4>
        <a href="/gudang/frameoriginal/export_excel" class="btn btn-success my-3" target="_blank">EXPORT EXCEL</a>
        ...
        <div class="table-responsive">
          <table class="table table-bordered table-contextual table-hover table-striped">
            ...
            <tbody>
             ...
             @foreach ($data_frameoriginal as $data)
             ...
             <tr>
               ...
               <td> {{ $data -> pj}} </td>
               <td>
                <a href="/super/frameoriginal/{{$data->id}}/edit" class="btn btn-warning btn-sm" role="button">Edit</a>
                <a href="/super/frameoriginal/delete/{{$data->id}}" class="btn btn-danger btn-sm" role="button">
          ...
          <div class="modal-dialog" role="document">
              <div class="modal-content">
                  <div class="modal-header">
                      ...
                      <div class="modal-body">
                          <form action="/super/gudang/frameoriginal/create" method="POST">
                              {{csrf_field()}}
                                  <div class="form-group">
