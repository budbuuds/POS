          ...
          <table class="table table-bordered table-contextual table-hover table-striped">
            ...
            <tbody>
             ...
             <tr>
               ...
               <td>
                    <a href="/idolblackkeluar/{{$keluar->id}}/edit" class="btn btn-warning btn-sm" role="button">Edit</a>
                    <a href="/idolblackkeluar/delete/{{$keluar->id}}" class="btn btn-danger btn-sm" role="button">
        ...
        <div class="modal-content">
            <div class="modal-header">
                ...
                <div class="modal-body">
                    <form action="/super/barangkeluar/softlens/idolblack/create" method="POST">
                        {{csrf_field()}}
