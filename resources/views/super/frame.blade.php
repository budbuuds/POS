        ...
        <button type="button" class="btn btn-info btn-fw" data-toggle="modal" data-target="#exampleModal">
          ...
          <div class="modal fade" id="importExcel" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog" role="document">
              <form method="post" action="/super/gudang/softlens/celebrityblack/import_excel" enctype="multipart/form-data">
          ...
          <table class="table table-bordered table-contextual table-hover table-striped">
            ...
            <tbody>
             ...
             <tr>
               ...
               <td> {{ $data -> pj}} </td>
               <td>
                <a href="/super/frame/{{$data->id}}/edit" class="btn btn-warning btn-sm" role="button">Edit</a>
                <a href="/super/frame/delete/{{$data->id}}" class="btn btn-danger btn-sm" role="button">
          ...
          <div class="modal-dialog" role="document">
              <div class="modal-content">
                  <div class="modal-header">
                      ...
                      <div class="modal-body">
                          <form action="/super/gudang/frame/create" method="POST">
                              {{csrf_field()}}
                                  <div class="form-group">
