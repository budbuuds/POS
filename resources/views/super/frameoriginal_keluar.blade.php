...
<div class="col-lg-12 stretch-card">
    <div class="card">
      <div class="card-body">
        <h4 class="card-title"> Frame Original Keluar </h4>
        <a href="/barangkeluar/frameoriginal/export_excel" class="btn btn-success my-3" target="_blank">EXPORT EXCEL</a>
        ...
        <div class="table-responsive">
          <table class="table table-bordered table-contextual table-hover table-striped">
            ...
            <tbody>
             ...
             @foreach ($frameoriginal_keluar as $data)

             <tr>
               <td> {{ $no++ }} </td>
               <td> {{ $data -> frameoriginal -> merek}} </td>
               <td> {{ $data -> warna}} </td>
               ...
               <td>
                <a href="/super/frameoriginalkeluar/{{$data->id}}/edit" class="btn btn-warning btn-sm" role="button">Edit</a>
                <a href="/super/frameoriginalkeluar/delete/{{$data->id}}" class="btn btn-danger btn-sm" role="button">
          ...
          <div class="modal-dialog" role="document">
              <div class="modal-content">
                  <div class="modal-header">
                      ...
                      <div class="modal-body">
                          <form action="/super/barangkeluar/frameoriginal/create" method="POST">
                              {{csrf_field()}}
                              <div class="form-group">
                                <label for="exampleFormControlSelect1">Merek</label>
                                <select name="frameoriginal_id" class="select2" multiple="multiple" id="exampleFormControlSelect1" style="width: 100%">
                                    @foreach ($frameoriginal_array as $array)
