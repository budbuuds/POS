...
<div class="col-lg-12 stretch-card">
    <div class="card">
      <div class="card-body">
        <h4 class="card-title"> Frame Umum </h4>
        <a href="/gudang/frame/umum/export_excel" class="btn btn-success my-3" target="_blank">EXPORT EXCEL</a>
         ...
         TAMBAH 
          ...
          <div class="modal fade" id="importExcel" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog" role="document">
              <form method="post" action="/gudang/frame/umum/import_excel" enctype="multipart/form-data">
        ...
        <div class="table-responsive">
          <table class="table table-bordered table-contextual table-hover table-striped">
            ...
            <tbody>
             ...
             @foreach ($data_frameumum as $data)
             ...
             <tr>
               ...
               <td> {{ $data -> keluar}} </td>
               <td>
                <a href="/frameumum/{{$data->id}}/edit" class="btn btn-warning btn-sm" role="button">Edit</a>
                <a href="/frameumum/delete/{{$data->id}}" class="btn btn-danger btn-sm" role="button">
          ...
          <div class="modal-dialog" role="document">
              <div class="modal-content">
                  <div class="modal-header">
                      ...
                      <div class="modal-body">
                          <form action="/super/frame/umum/create" method="POST">
                              {{csrf_field()}}
                                  <div class="form-group">
