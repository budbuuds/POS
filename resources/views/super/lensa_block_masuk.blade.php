          ...
          <table class="table table-bordered table-contextual table-hover table-striped">
            ...
            <tbody>
             ...
             <tr>
               ...
               <td> {{ $masuk -> pj }} </td>
               <td> 
                    <a href="/lensablockmasuk/{{$masuk->id}}/edit" class="btn btn-warning btn-sm" role="button">Edit</a>
                    <a href="/lensablockmasuk/delete/{{$masuk->id}}" class="btn btn-danger btn-sm" role="button">
        ...
        <div class="modal-content">
            <div class="modal-header">
                ...
                <div class="modal-body">
                    <form action="/super/barangmasuk/lensa/block/create" method="POST">
                        {{csrf_field()}}
