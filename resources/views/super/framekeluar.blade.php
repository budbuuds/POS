          ...
          <table class="table table-bordered table-contextual table-hover table-striped">
            ...
            <tbody>
             ...
             <tr>
               ...
               <td>
                <a href="/super/framekeluar/{{$data->id}}/edit" class="btn btn-warning btn-sm" role="button">Edit</a>
                <a href="/super/framekeluar/delete/{{$data->id}}" class="btn btn-danger btn-sm" role="button">
          ...
          <div class="modal-dialog" role="document">
              <div class="modal-content">
                  <div class="modal-header">
                      ...
                      <div class="modal-body">
                          <form action="/super/barangkeluar/frame/create" method="POST">
                              {{csrf_field()}}
                              <div class="form-group">
