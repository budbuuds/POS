                    ...
                    <div class="main-banner">
                        <div class="d-sm-flex justify-content-between">
                            ...
                            <div class="mt-5 mt-lg-0">
                                <img src="{{ url('frontend/images/group.png')}}" alt="marsmello" class="img-fluid" data-aos="zoom-in-up">
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="row" data-aos="fade-up">
                <div class="col-sm-4 text-center text-lg-left">
                    <div class="services-box" data-aos="fade-down" data-aos-easing="linear" data-aos-duration="1500">
                        <img src="{{ url('frontend/images/integrated-marketing.svg')}}" alt="integrated-marketing" data-aos="zoom-in">
                ...
                <div class="col-sm-4 text-center text-lg-left">
                    <div class="services-box"   data-aos="fade-down" data-aos-easing="linear" data-aos-duration="1500">
                        <img src="{{ url('frontend/images/design-development.svg')}}" alt="design-development" data-aos="zoom-in">
                ...
                <div class="col-sm-4 text-center text-lg-left">
                    <div class="services-box" data-aos="fade-down" data-aos-easing="linear" data-aos-duration="1500">
                        <img src="{{ url('frontend/images/digital-strategy.svg')}}" alt="digital-strategy" data-aos="zoom-in">
            ...
            <div class="row" data-aos="fade-up">
                <div class="col-sm-4 text-center text-lg-left">
                    <div class="services-box  pb-lg-0" data-aos="fade-down" data-aos-easing="linear" data-aos-duration="1500">
                        <img src="{{ url('frontend/images/digital-marketing.svg')}}" alt="digital-marketing" data-aos="zoom-in">
                        <h6 class="text-dark mb-3 mt-4 font-weight-medium">Digital 
                            Marketing
                        </h6>
                        <p>Lorem ipsum dolor sit amet, 
                ...
                <div class="col-sm-4 text-center text-lg-left">
                    <div class="services-box pb-lg-0" data-aos="fade-down" data-aos-easing="linear" data-aos-duration="1500">
                        <img src="{{ url('frontend/images/growth-strategy.svg')}}" alt="growth-strategy" data-aos="zoom-in">
                ...
                <div class="col-sm-4 text-center text-lg-left">
                    <div class="services-box pb-0" data-aos="fade-down" data-aos-easing="linear" data-aos-duration="1500">
                        ...
                        <img src="{{ url('frontend/images/saving-strategy.svg')}}" alt="saving-strategy" data-aos="zoom-in">
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-sm-6 text-right" data-aos="flip-left" data-aos-easing="ease-out-cubic" data-aos-duration="2000">
                    <img src="{{ url('frontend/images/idea.png')}}" alt="idea" class="img-fluid">
                </div>
            </div>
        </div>
    </section>
    <section class="our-projects" id="projects">
        ...
        <div class="mb-5" data-aos="fade-up">
            <div class="owl-carousel-projects owl-carousel owl-theme">
                <div class="item">
                    <img src="{{ url('frontend/images/carousel/slider1.jpg')}}" alt="slider">
                </div>
                <div class="item">
                    <img src="{{ url('frontend/images/carousel/slider2.jpg')}}" alt="slider">
                </div>
                <div class="item">
                    <img src="{{ url('frontend/images/carousel/slider3.jpg')}}" alt="slider">
                </div>
                <div class="item">
                    <img src="{{ url('frontend/images/carousel/slider4.jpg')}}" alt="slider">
                </div>
                <div class="item">
                    <img src="{{ url('frontend/images/carousel/slider5.jpg')}}" alt="slider">
                </div>
                <div class="item">
                    <img src="{{ url('frontend/images/carousel/slider1.jpg')}}" alt="slider">
                </div>
