            ...
            <ul class="nav">
              ...
              <li class="nav-item menu-items">
                ...
                <div class="collapse" id="gudang">
                  <ul class="nav flex-column sub-menu">
                    <li class="nav-item"> <a class="nav-link" href="/gudang/gudang_lensa">Lensa</a></li>
                    <li class="nav-item"> <a class="nav-link" href="/gudang/gudang_softlens">Soft Lens</a></li>
                    <li class="nav-item"> <a class="nav-link" href="/gudang/gudang_frame">Frame</a></li>
                  </ul>
                </div>
              </li>
              <li class="nav-item menu-items">
                ...
                <div class="collapse" id="masuk">
                  <ul class="nav flex-column sub-menu">
                    <li class="nav-item"> <a class="nav-link" href="/barangmasuk/masuk_lensa">Lensa</a></li>
                    <li class="nav-item"> <a class="nav-link" href="/barangmasuk/masuk_softlens">Soft Lens</a></li>
                  </ul>
                </div>
              </li>
              <li class="nav-item menu-items">
                ...
                <div class="collapse" id="keluar">
                  <ul class="nav flex-column sub-menu">
                    <li class="nav-item"> <a class="nav-link" href="/barangkeluar/keluar_lensa">Lensa</a></li>
                    <li class="nav-item"> <a class="nav-link" href="/barangkeluar/keluar_softlens">Soft Lens</a></li>
                    <li class="nav-item"> <a class="nav-link" href="/barangkeluar/keluar_frame">Frame</a></li>
                  </ul>
                </div>
              </li>
              <li class="nav-item menu-items">
                ...
                <div class="collapse" id="frame">
                  <ul class="nav flex-column sub-menu">
                    <li class="nav-item"> <a class="nav-link" href="/framebpjs">Bpjs</a></li>
                    <li class="nav-item"> <a class="nav-link" href="/frameumum">Umum</a></li>
                  </ul>
                </div>
              </li>
              <li class="nav-item menu-items">
              ...
              <li class="nav-item menu-items">
                ...
                <div class="collapse" id="toko">
                  <ul class="nav flex-column sub-menu">
                    <li class="nav-item"> <a class="nav-link" href="/emeral">Emeral</a></li>
                    <li class="nav-item"> <a class="nav-link" href="/tiara">Tiara</a></li>
                  </ul>
                </div>
              </li>
