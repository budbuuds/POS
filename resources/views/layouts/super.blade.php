        ...
        <div class="container-scroller">
          ...
          <nav class="sidebar sidebar-offcanvas" id="sidebar">
            ...
            <ul class="nav">
              ...
              <li class="nav-item menu-items">
                ...
                <div class="collapse" id="gudang">
                  <ul class="nav flex-column sub-menu">
                    <li class="nav-item"> <a class="nav-link" href="/super/gudang/gudang_lensa">Lensa</a></li>
                    <li class="nav-item"> <a class="nav-link" href="/super/gudang/gudang_softlens">Soft Lens</a></li>
                    <li class="nav-item"> <a class="nav-link" href="/super/gudang/gudang_frame">Frame</a></li>
                  </ul>
                </div>
              </li>
              <li class="nav-item menu-items">
                <a class="nav-link" data-toggle="collapse" href="#masuk" aria-expanded="false" aria-controls="masuk">
                  <span class="menu-icon">
                ...
                <div class="collapse" id="masuk">
                  <ul class="nav flex-column sub-menu">
                    <li class="nav-item"> <a class="nav-link" href="/super/barangmasuk/masuk_lensa">Lensa</a></li>
                    <li class="nav-item"> <a class="nav-link" href="/super/barangmasuk/masuk_softlens">Soft Lens</a></li>
                  </ul>
                </div>
              </li>
              <li class="nav-item menu-items">
                <a class="nav-link" data-toggle="collapse" href="#keluar" aria-expanded="false" aria-controls="keluar">
                  <span class="menu-icon">
                ...
                <div class="collapse" id="keluar">
                  <ul class="nav flex-column sub-menu">
                    <li class="nav-item"> <a class="nav-link" href="/super/barangkeluar/keluar_lensa">Lensa</a></li>
                    <li class="nav-item"> <a class="nav-link" href="/super/barangkeluar/keluar_softlens">Soft Lens</a></li>
                    <li class="nav-item"> <a class="nav-link" href="/super/barangkeluar/keluar_frame">Frame</a></li>
                  </ul>
                </div>
              </li>
              <li class="nav-item menu-items">
                <a class="nav-link" data-toggle="collapse" href="#frame" aria-expanded="false" aria-controls="toko">
                  <span class="menu-icon">
                ...
                <div class="collapse" id="frame">
                  <ul class="nav flex-column sub-menu">
                    <li class="nav-item"> <a class="nav-link" href="/super/framebpjs">Bpjs</a></li>
                    <li class="nav-item"> <a class="nav-link" href="/super/frameumum">Umum</a></li>
                  </ul>
                </div>
              </li>
              <li class="nav-item menu-items">
                <a class="nav-link" href="/super/laporan">
                  <span class="menu-icon">
              ...
              <li class="nav-item menu-items">
                <a class="nav-link" data-toggle="collapse" href="#toko" aria-expanded="false" aria-controls="toko">
                  <span class="menu-icon">
                ...
                <div class="collapse" id="toko">
                  <ul class="nav flex-column sub-menu">
                    <li class="nav-item"> <a class="nav-link" href="/super/emeral">Emeral</a></li>
                    <li class="nav-item"> <a class="nav-link" href="/super/tiara">Tiara</a></li>
                  </ul>
                </div>
              </li>
              <li class="nav-item menu-items">
            ...
            <div div class="container-fluid page-body-wrapper">
                ...
                <nav class="navbar p-0 fixed-top d-flex flex-row">
                    <div class="navbar-brand-wrapper d-flex d-lg-none align-items-center justify-content-center">
                        <a class="navbar-brand brand-logo-mini" href="index.html"><img src="{{ url('backend/template/assets/images/logo-mini.svg')}}" alt="logo" /></a>
                    </div>
