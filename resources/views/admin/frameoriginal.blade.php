          ...
          <table class="table table-bordered table-contextual table-hover table-striped">
            ...
            <tbody>
             ...
             <tr>
               ...
               <td> {{ $data -> pj}} </td>
               <td>
                <a href="/frameoriginal/{{$data->id}}/edit" class="btn btn-warning btn-sm" role="button">Edit</a>
                <a href="/frameoriginal/delete/{{$data->id}}" class="btn btn-danger btn-sm" role="button">
          ...
          <div class="modal-dialog" role="document">
              <div class="modal-content">
                  <div class="modal-header">
                      ...
                      <div class="modal-body">
                          <form action="/gudang/frameoriginal/create" method="POST">
                              {{csrf_field()}}
                                  <div class="form-group">
